...
class AntennaCNN(nn.Module):
    def __init__(self):
        ...
        """
        self.conv_1 = nn.Conv2d(1, 96, kernel_size=8, stride=1, padding='same')
        self.batchnorm_1 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_2 = nn.Conv2d(96, 96, kernel_size=6, stride=1, padding='same')
        self.batchnorm_2 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_3 = nn.Conv2d(96, 96, kernel_size=5, stride=1, padding='same')
        ...
        """
        self.conv_4 = nn.Conv2d(96, 96, kernel_size=5, stride=1, padding='same')
        ...
        """
        self.conv_5 = nn.Conv2d(96, 96, kernel_size=4, stride=1, padding='same')
        self.batchnorm_5 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_6 = nn.Conv2d(96, 96, kernel_size=4, stride=1, padding='same')
        self.batchnorm_6 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_7 = nn.Conv2d(96, 96, kernel_size=4, stride=1, padding='same')
        self.batchnorm_7 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_8 = nn.Conv2d(96, 96, kernel_size=3, stride=1, padding='same')
        self.batchnorm_8 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_9 = nn.Conv2d(96, 96, kernel_size=3, stride=1, padding='same')
        self.batchnorm_9 = nn.BatchNorm2d(96)
        ...
        """
        self.conv_10 = nn.Conv2d(96, 96, kernel_size=3, stride=1, padding='same')
        self.batchnorm_10 = nn.BatchNorm2d(96)
        ...
        """
        # output of previous conv2d layer is 96 filters 12x12 still
        self.fc_1 = nn.Linear(96 * 12 * 12, 2000)
        self.batchnorm_11 = nn.BatchNorm1d(2000)
        self.leakyrelu_11 = nn.LeakyReLU(0.01)

        self.dropout_1 = nn.Dropout(0.5)

        self.fc_2 = nn.Linear(2000, 2000)
        self.batchnorm_12 = nn.BatchNorm1d(2000)
        self.leakyrelu_12 = nn.LeakyReLU(0.01)

        self.dropout_2 = nn.Dropout(0.5)

        self.fc_3 = nn.Linear(2000, 2000)
        self.batchnorm_13 = nn.BatchNorm1d(2000)
        self.leakyrelu_13 = nn.LeakyReLU(0.01)

        self.dropout_3 = nn.Dropout(0.5)

        self.fc_4 = nn.Linear(2000, 2000)
        self.batchnorm_14 = nn.BatchNorm1d(2000)
